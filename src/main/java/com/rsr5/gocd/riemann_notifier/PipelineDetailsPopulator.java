...
public class PipelineDetailsPopulator {
    ...
    protected RetrievePipelineInstance retrievePipelineInstance = new RetrievePipelineInstance();
    ...
    protected JsonElement downloadPipelineDetails(String pipelineName) throws IOException {
        ...
        HttpURLConnection request = retrievePipelineInstance.download(pipelineName);
